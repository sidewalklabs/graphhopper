...
public final class CustomPtRouteResource {
    ...
    private final CustomTripFromLabel tripFromLabel;
    ...
    public CustomPtRouteResource(TranslationMap translationMap, GraphHopperStorage graphHopperStorage, LocationIndex locationIndex, GtfsStorage gtfsStorage, RealtimeFeed realtimeFeed) {
        ...
        this.tripFromLabel = new CustomTripFromLabel(this.gtfsStorage, this.realtimeFeed);
    }
    ...
    public static class Factory {
        ...
        public CustomPtRouteResource createWith(GtfsRealtime.FeedMessage realtimeFeed) {
            Map<String, GtfsRealtime.FeedMessage> realtimeFeeds = new HashMap<>();
            realtimeFeeds.put("gtfs_0", realtimeFeed);
            return new CustomPtRouteResource(translationMap, graphHopperStorage, locationIndex, gtfsStorage, RealtimeFeed.fromProtobuf(graphHopperStorage, gtfsStorage, ptEncodedValues, realtimeFeeds));
        }

        public CustomPtRouteResource createWithoutRealtimeFeed() {
            return new CustomPtRouteResource(translationMap, graphHopperStorage, locationIndex, gtfsStorage, RealtimeFeed.empty(gtfsStorage));
        }
    }
