...
class CustomTripFromLabel {
    ...
    CustomTripFromLabel(GtfsStorage gtfsStorage, RealtimeFeed realtimeFeed) {
        this.gtfsStorage = gtfsStorage;
        this.realtimeFeed = realtimeFeed;
    }

    public static class CustomPtLeg extends Trip.Leg {
        ...
        public Date getDepartureTime() {
            return ((Trip.Stop)this.stops.get(0)).departureTime;
        }
