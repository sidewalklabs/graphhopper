...
public class GraphHopperMultimodalIT {
    ...
    private static CustomPtRouteResource graphHopper;
    ...
    public static void init() {
        ...
        graphHopper = CustomPtRouteResource.createFactory(new TranslationMap().doImport(), graphHopperGtfs, locationIndex, graphHopperGtfs.getGtfsStorage())
