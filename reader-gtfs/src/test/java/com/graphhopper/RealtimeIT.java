...
public class RealtimeIT {
    ...
    private static CustomPtRouteResource.Factory graphHopperFactory;
    ...
    public static void init() {
        ...
        graphHopperGtfs.init(ghConfig);
        graphHopperGtfs.importOrLoad();
        graphHopperFactory = CustomPtRouteResource.createFactory(new TranslationMap().doImport(), graphHopperGtfs, graphHopperGtfs.getLocationIndex(), graphHopperGtfs.getGtfsStorage());
    }
...
//        assertEquals(2, response.getAll().size());
    ...
    public void testMissedTransferBecauseOfDelayBackwards() {
        ...
        CustomPtRouteResource graphHopper = graphHopperFactory.createWith(feedMessageBuilder.build());
